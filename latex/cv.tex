...
\begin{itemize}
    \item M. Bendel, S. W. Bailey, \textbf{Mithilesh Vaidya}, S. Badam and X. He. ``Goodbye Drift: Anchored Tree Sampling for Long-Horizon Video-to-Video Generation.'' arXiv preprint \href{https://arxiv.org/abs/2605.20476}{arXiv:2605.20476} (2026).
    ...
    \item \textbf{M. Vaidya}, K. Sabu and P. Rao. ``Deep Learning for Prominence Detection In Children's Read Speech.'' In Proc. \href{https://doi.org/10.1109/ICASSP43922.2022.9747780}{ICASSP}, pp. 8157--8161 (2022).
...
\vspace{-12pt}
\begin{itemize}
\item Co-led development of \href{https://descriptinc.github.io/uvm-v2/}{\textbf{Audio Regenerate}}, a latent speech inpainting model consisiting of a continuous neural audio codec and a flow-matching generator, for masked latent inpainting; used for word-level audio editing in Descript
...
\item Wrote a pipeline for large-scale distributed processing of raw videos to obtain datasets used in training \newline \href{https://descriptinc.github.io/video-regenerate/}{\textbf{Video Regenerate}}, an audio-driven lip-sync model for video editing and translation
\item Co-authored \href{https://arxiv.org/abs/2605.20476}{\textbf{ATS}}, a training-free tree sampler that replaces autoregressive rollout with sparse-to-dense imputation for long-horizon video-to-video generation
\item Worked on an improved audio-visual sync contrastive model for fixing frame-level audio-visual misalignment
\item Currently working on a modern audio-text forced aligner for obtaining word-level timestamps
\end{itemize}
\end{itemize}
\vspace{5pt}
\begin{itemize}
...
\textit{Guide: Prof. Preeti Rao, IIT Bombay | \href{https://doi.org/10.1109/ICASSP43922.2022.9747780}{ICASSP}} \hfill {\sl Master's Thesis I}\\
\vspace{-10pt}
\begin{itemize}
